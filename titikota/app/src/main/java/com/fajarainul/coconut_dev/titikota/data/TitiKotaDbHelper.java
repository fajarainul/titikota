 ...
 */
public class TitiKotaDbHelper extends SQLiteOpenHelper {

    // If you change the database schema, you must increment the database version.
    private static final int DATABASE_VERSION = 1;

    static final String DATABASE_NAME = "titikota.db";

    public TitiKotaDbHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_TWEET_TABLE = "CREATE TABLE " + TweetEntry.TABLE_NAME + " (" +
                TweetEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
        ...
        final String SQL_CREATE_PZ_TABLE = "";
