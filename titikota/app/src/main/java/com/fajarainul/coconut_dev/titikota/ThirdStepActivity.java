...
public class ThirdStepActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_to_fourth = (Button)findViewById(R.id.toFourth);

        btn_to_fourth.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_third_step, menu);
        return true;
    }
